...
public:
	...
	virtual void			BuildAdjacentMapList(void) = 0; // build the list of maps adjacent to the current map
	...
	virtual bool			ShouldHideServer(void) = 0; // returns true if the game dll wants the server not to be made public
	...
	virtual void			GameServerSteamAPIShutdown(void) = 0; // called after the steam API has been shutdown post-level startup
